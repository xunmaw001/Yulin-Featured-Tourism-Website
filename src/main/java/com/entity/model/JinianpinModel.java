 ...
 */
public class JinianpinModel  implements Serializable {
	...
	public void setShangpintese(String shangpintese) {
		this.shangpintese = shangpintese;
	}
	
	/**
	 * 获取：商品特色
	 */
	public String getShangpintese() {
		return shangpintese;
	}
