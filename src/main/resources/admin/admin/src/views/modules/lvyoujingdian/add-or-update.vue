	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="所在城市" prop="suozaichengshi">
					<el-input v-model="ruleForm.suozaichengshi" placeholder="所在城市" clearable  :readonly="ro.suozaichengshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="所在城市" prop="suozaichengshi">
					<el-input v-model="ruleForm.suozaichengshi" placeholder="所在城市" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="售票链接" prop="shoupiaolianjie">
					<el-input v-model="ruleForm.shoupiaolianjie" placeholder="售票链接" clearable  :readonly="ro.shoupiaolianjie"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="售票链接" prop="shoupiaolianjie">
					<el-input v-model="ruleForm.shoupiaolianjie" placeholder="售票链接" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="门票价格" prop="menpiaojiage">
					<el-input v-model="ruleForm.menpiaojiage" placeholder="门票价格" clearable  :readonly="ro.menpiaojiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="门票价格" prop="menpiaojiage">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="textarea" v-if="type!='info'" label="名优小吃" prop="mingyouxiaochi">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else-if="ruleForm.mingyouxiaochi" label="名优小吃" prop="mingyouxiaochi">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.mingyouxiaochi}}</span>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-if="type!='info'"  label="注意事项" prop="zhuyishixiang">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else-if="ruleForm.zhuyishixiang" label="注意事项" prop="zhuyishixiang">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jingdianjieshao = this.ruleForm.jingdianjieshao.replace(reg,'../../../springboot8f7p0/upload');
        this.ruleForm.zhuyishixiang = this.ruleForm.zhuyishixiang.replace(reg,'../../../springboot8f7p0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
