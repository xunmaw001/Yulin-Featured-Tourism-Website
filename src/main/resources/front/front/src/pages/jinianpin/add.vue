...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.0)"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}'  label="产品分类" prop="chanpinfenlei">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="商品特色" prop="shangpintese">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="商品特色"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="产品详情" prop="chanpinxiangqing">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/chanpinfenlei/chanpinfenlei', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('jinianpin/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('jinianpin/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
